    ...
    public partial class InitialStructure : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Room_Id, t.Member_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Messages", "Author_Id", "dbo.Members");
            DropForeignKey("dbo.RoomMembers", "Member_Id", "dbo.Members");
            DropForeignKey("dbo.RoomMembers", "Room_Id", "dbo.Rooms");
            DropIndex("dbo.RoomMembers", new[] { "Member_Id" });
            DropIndex("dbo.RoomMembers", new[] { "Room_Id" });
